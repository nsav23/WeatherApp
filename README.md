...
✨ Features
    ...
    • 🔄 Auto-refreshing UI using AJAX (Fetch API) 
...
⚡ Installation
    ...
    4. While the Arduino is running execute the python script from the terminal: python3 dht_data_log.py (make sure the Serial port in the Arduino IDE is closed before doing that)
